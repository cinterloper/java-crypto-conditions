...
public class RsaSha256FulfillmentSignatureSpi extends FulfillmentSignatureSpi {
	...
	@Override
	protected void validateSignature(PrivateKey privateKey, byte[] signature) throws SignatureException {
		...
		byte[] modulus = UnsignedBigInteger.toUnsignedByteArray(((RSAPrivateKey) privateKey).getModulus());
	...
	@Override
	protected Fulfillment getFulfillment(PrivateKey privateKey, byte[] signature) throws SignatureException {
	...
	protected PublicKey getInternalPublicKey(Fulfillment fulfillment) throws SignatureException {
		...
		RSAPublicKeySpec keySpec = new RSAPublicKeySpec(
				((RsaSha256Fulfillment) fulfillment).getModulus(), 
				RsaSha256Fulfillment.RSA_PUBLIC_EXPONENT);
	...
	private boolean isValidRsaKeyPair(BigInteger privExponent, BigInteger pubExponent, BigInteger sharedModulus) {
