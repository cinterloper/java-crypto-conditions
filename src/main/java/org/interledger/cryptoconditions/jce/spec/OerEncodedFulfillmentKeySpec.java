...
/**
 * This class represents the ASN.1 encoding of a fulfillment,
 * encoded according to the ASN.1 type {@code Fulfillment} using OER encoding rules.
 * 
 * The {@code Fulfillment} syntax is defined in the Crypto-Conditions standard
 * as follows:
 *
 * <pre>
