...
public class ConditionOerInputStream extends OerInputStream {
	...
	protected EnumSet<FeatureSuite> readFeatures() 
			throws IOException, UnsupportedFeaturesException, UnsupportedLengthException, IllegalOerLengthIndicatorException {
			...
			EnumSet<FeatureSuite> features = FeatureSuiteOerEncoding.getFeaturesFromBitmask(bitmask_bytes[0]);
