...
public class FulfillmentOerInputStream extends OerInputStream {
	...
	public Fulfillment readFulfillment() 
			throws IOException, UnsupportedConditionException, OerDecodingException, IllegalFulfillmentException
	{
	...
	public RsaSha256Fulfillment readRsaSha256FulfillmentPayload() 
			throws IOException, UnsupportedLengthException, IllegalOerLengthIndicatorException, IllegalFulfillmentException {
	...
	public ConditionType readConditiontype() 
			throws IOException {
