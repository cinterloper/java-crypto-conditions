...
public class TestEd25519Fulfillment {
    ...
    public void testEd25519Fulfillment() throws IOException, UnsupportedConditionException, OerDecodingException, NoSuchAlgorithmException, InvalidKeySpecException, IllegalFulfillmentException {
        ...
        // Build from secret
        ff_ok = Ed25519Fulfillment.fromPrivateKeyAndMessage(Ed25519Signature.getPrivateKeyFromBytes(TEST_SEED), TEST_MSG);
        ff_ok.computeCondition();
        assertTrue("Fulfillment validates TEST_MSG", ff_ok.validate(TEST_MSG));

        ff_ok = Ed25519Fulfillment.fromPrivateKeyAndMessage(Ed25519Signature.getPrivateKeyFromBytes(TEST_SEED), TEST_KO_MSG);
        ff_ok.computeCondition();
