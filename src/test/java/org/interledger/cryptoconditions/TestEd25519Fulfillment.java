...
//
//    private Fulfillment getPayload(byte[] ffOEREncoded) throws IOException, UnsupportedConditionException, OerDecodingException, NoSuchAlgorithmException, InvalidKeySpecException, IllegalFulfillmentException {
...
//
//    @Test
//    public void testEd25519Fulfillment() throws IOException, UnsupportedConditionException, OerDecodingException, NoSuchAlgorithmException, InvalidKeySpecException, IllegalFulfillmentException {
        // Build from stream
...
//        assertFalse("Fulfillment does not validates TEST_KO_MSG", ff_wrong.validate(TEST_KO_MSG));
        ...
        // Build from secret
//        ff_ok = Ed25519FulfillmentImpl.fromPrivateKeyAndMessage(Ed25519Signature.getPrivateKeyFromBytes(TEST_SEED), TEST_MSG);
//        ff_ok.computeCondition();
//        assertTrue("Fulfillment validates TEST_MSG", ff_ok.validate(TEST_MSG));
//
//        ff_ok = Ed25519FulfillmentImpl.fromPrivateKeyAndMessage(Ed25519Signature.getPrivateKeyFromBytes(TEST_SEED), TEST_KO_MSG);
//        ff_ok.computeCondition();
